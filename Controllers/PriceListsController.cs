...
namespace ShiSida_Engineering.Controllers
{
    ...
    {
        private readonly ShiSida_EngineeringContext _context;

        public PriceListsController(ShiSida_EngineeringContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Price")] PriceList priceList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ReleaseDate,Price")] PriceList priceList)
        {
            if (id != priceList.Id)
            {
                return NotFound();
